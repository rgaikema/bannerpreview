...
window.onload = function() {
    ...
    var container = document.querySelector('.container'),
        ...
        tl
            ...
            .set (grass, { y: 280, rotationZ: 0.01, force3D: true })
            ...
            .to (grass, 1.5, { y: 60, rotationZ: 0.01, force3D: true }, 'parallax')
            ...
            .to (grass, 2.2, { y: 280, rotationZ: 0.01, force3D: true }, 'reverse')
         ...
         exit.addEventListener('mouseleave', function(){
            if(allowHover){
                ...
                //Parallax background
                TweenLite.to(grass, .6, { y: 280, rotationZ: 0.01, force3D: true })
        ...
        exit.addEventListener("mousemove", function(evt){
            ...
            if (direction == "up") {
                if(allowHover){
                    //Parallax background
                    TweenLite.to(grass, .8, { y: 275, rotationZ: 0.01, force3D: true }, "up")
             ...
             if (direction == "down") {
                if(allowHover){
                    //Parallax background
                    TweenLite.to(grass, 1, { y: 300, rotationZ: 0.01, force3D: true }, "down")
